...
# Snapshot information refresh (IFA/IFV only while powered on)
INFO_REFRESH_INTERVAL = 60.0
INFO_REFRESH_POWER_ON_DELAY = 1.5
INFO_REFRESH_SOURCE_CHANGE_DELAY = 1.0
INFO_REFRESH_LISTENING_MODE_SETTLE = 0.15
INFO_REFRESH_QUERY_GAP = 0.1
